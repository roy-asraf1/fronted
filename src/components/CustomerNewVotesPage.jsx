...
const CustomerNewVotesPage = ({ contract, account, username, onLogout }) => {
  ...
  const loadVotes = useCallback(async () => {
    ...
    for (let i = 0; i < voteCount; i++) {
      ...
      if (voteDetails.isOpen && !hasVoted) {
        tempVotes.push({
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-6">
      ...
      <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-lg mt-6">
        ...
        <h2 className="text-2xl font-semibold text-gray-700 mb-4">New Votes</h2>
...
export default CustomerNewVotesPage;
